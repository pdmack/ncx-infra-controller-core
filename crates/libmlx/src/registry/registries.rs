        ...
        crate::variables::registry::MlxVariableRegistry::new("mlx_generic")
            ...
            .variables(vec![
                crate::variables::variable::MlxConfigVariable::builder()
                    ...
                    .read_only(false)
                    .spec(crate::variables::spec::MlxVariableSpec::builder().boolean().build())
                    .build(),
                crate::variables::variable::MlxConfigVariable::builder()
                    ...
                    .read_only(false)
                    .spec(crate::variables::spec::MlxVariableSpec::builder().integer().build())
                    .build(),
                crate::variables::variable::MlxConfigVariable::builder()
                ...
                crate::variables::variable::MlxConfigVariable::builder()
                    ...
                    .read_only(false)
                    .spec(crate::variables::spec::MlxVariableSpec::builder().enum_type().with_options(vec!["ENABLED".to_string(), "DISABLED".to_string()]).build())
                    .build(),
                crate::variables::variable::MlxConfigVariable::builder()
                ...
                crate::variables::variable::MlxConfigVariable::builder()
                    ...
                    .read_only(false)
                    .spec(crate::variables::spec::MlxVariableSpec::builder().enum_type().with_options(vec!["DEVICE_DEFAULT".to_string(), "STATIC_MODE".to_string(), "ACCUMULATIVE".to_string(), "DISABLED".to_string()]).build())
                    .build(),
                crate::variables::variable::MlxConfigVariable::builder()
                    .name("MULTIPATH_DSCP".to_string())
                    .description("Multipath on transmit, set the DSCP bit to hold the MP eligible info.".to_string())
                    .read_only(false)
                    .spec(crate::variables::spec::MlxVariableSpec::builder().enum_type().with_options(vec!["DEVICE_DEFAULT".to_string(), "DISABLE".to_string(), "DSCP_0".to_string(), "DSCP_1".to_string(), "DSCP_2".to_string()]).build())
                    .build(),
                crate::variables::variable::MlxConfigVariable::builder()
                ...
                crate::variables::variable::MlxConfigVariable::builder()
                    ...
                    .read_only(false)
                    .spec(crate::variables::spec::MlxVariableSpec::builder().enum_type().with_options(vec!["DEVICE_DEFAULT".to_string(), "FIXED_VALUE".to_string(), "RTT_REQUEST".to_string()]).build())
                    .build(),
                crate::variables::variable::MlxConfigVariable::builder()
                    .name("PCI_DOWNSTREAM_PORT_OWNER".to_string())
                    .description("Identifies the owner of the respective PCI Downstream Port.".to_string())
                    .read_only(false)
                    .spec(crate::variables::spec::MlxVariableSpec::builder().enum_array().with_options(vec!["DEVICE_DEFAULT".to_string(), "EMBEDDED_CPU".to_string(), "HOST_0".to_string(), "HOST_1".to_string(), "HOST_2".to_string(), "HOST_3".to_string(), "HOST_4".to_string(), "HOST_5".to_string(), "HOST_6".to_string(), "HOST_7".to_string()]).with_size(16).build())
                    .build(),
                crate::variables::variable::MlxConfigVariable::builder()
                    .name("ROCE_CC_STEERING_EXT".to_string())
                    .description("Defines CC extension for packet steering".to_string())
                    .read_only(false)
                    .spec(crate::variables::spec::MlxVariableSpec::builder().enum_type().with_options(vec!["DEVICE_DEFAULT".to_string(), "DISABLED".to_string(), "ENABLED".to_string()]).build())
                    .build(),
            ]),
]
    },
